...
export default {
  ...
  methods: {
    async handleSubmit() {
      try {
        // Fazendo requisição POST para criar a vaga
        ...
        // Trata e exibe erros
        console.error("Erro ao criar a vaga:", error.response.data);
        alert("Erro ao criar a vaga. Verifique os dados.");
      }
    },
  },
};
